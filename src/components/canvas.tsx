...
const dispatcher: d3.Dispatch<any> = d3.dispatch('remove-circle');
const { innerWidth, innerHeight } = window as { innerWidth: number; innerHeight: number };
