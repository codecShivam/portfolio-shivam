...
const Contact: React.FC = () => {
  ...
  return (
    <animated.div style={animationProps}>
      <div className="absolute sm:left-[10%] left-0 sm:top-[11%] top-[6%] right-0 sm:right-[10%]" id="contact">
        <div className="content pt-12">
          <div className="mx-auto px-16" >
            <div className="mb-5 flex items-center max-w-md">
              <h2 className="text-gray-500 text-4xl font-bold"> Contact Me</h2>
            </div>
              ...
              >
                <div className="max-w-[570px] mb-12 lg:mb-0">
                  ...
                  <p className="text-2xl font-medium text-body-color leading-relaxed mb-9 mx-5">
                    I am excited to hear from you and explore how we can work
                    together. Whether you have a question, a project proposal,
                    or just want to say hello, I am always ready to engage in
